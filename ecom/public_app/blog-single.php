			...
			<div class="row">
				...
				<div class="col-sm-9">
						...
						<div class="single-blog-post">
							...
							<div class="pager-area">
								<ul class="pager pull-right">
									<li><a href="#"><?php echo $LANG_PRE;?></a></li>
									<li><a href="#"><?php echo $LANG_NEXT;?></a></li>
								</ul>
							</div>
						</div>
					</div><!--/blog-post-area-->
					...
					<div class="rating-area">
						<ul class="ratings">
							<li class="rate-this"><?php echo $LANG_RATE_THIS_ITEM;?></li>
							<li>
					...
					<div class="media commnets">
						...
						<div class="media-body">
							...
							<div class="blog-socials">
								...
								<a class="btn btn-primary" href=""><?php echo $LANG_OTHER_POSTS;?></a>
							</div>
						</div>
					</div><!--Comments-->
						...
						<ul class="media-list">
							<li class="media">
								...
								<div class="media-body">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<a class="btn btn-primary" href=""><i class="fa fa-reply"></i><?php echo $LANG_REPLY;?></a>
								</div>
							</li>
					...
					<div class="replay-box">
						<div class="row">
							<div class="col-sm-4">
								<h2><?php echo $LANG_LEAVE_A_REPLY;?></h2>
								<form>
									<div class="blank-arrow">
										<label><?php echo $LANG_YOUR_NAME;?></label>
									</div>
									<span>*</span>
									<input type="text" placeholder="write your name...">
									<div class="blank-arrow">
										<label><?php echo $LANG_EMAIL_ADDRESS;?></label>
									</div>
									<span>*</span>
									<input type="email" placeholder="your email address...">
									<div class="blank-arrow">
										<label><?php echo $LANG_WEB_SITE;?></label>
									</div>
							...
							<div class="col-sm-8">
								<div class="text-area">
									<div class="blank-arrow">
										<label><?php echo $LANG_YOUR_COMMENT;?></label>
									</div>
									<span>*</span>
									<textarea name="message" rows="11"></textarea>
									<a class="btn btn-primary" href=""><?php echo $LANG_POST_COMMENT;?></a>
								</div>
							</div>
						</div>
					</div><!--/Repaly Box-->
