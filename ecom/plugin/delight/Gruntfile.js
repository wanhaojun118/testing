    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            jsinit_js: {
                ...
                files: [{
                    expand: true,
                    cwd: '<%= meta.init_js_root %>',
                    src: ['**/*.js'],
                    dest: '<%= meta.assets_minified_root %>/js-init',
                    ext: '.js'
                }]
            ...
            admin_demo_js: {
                ...
                files: {
                    '<%= meta.assets_minified_DEMO %>admin-all-demo.js': [
                        ...
                        '<%= meta.assets_root %>/widgets/material/material.js',
                        '<%= meta.assets_root %>/widgets/material/ripples.js',
        ...
        cssmin: {
            ...
            material_css: {
                expand: true,
                cwd: '<%= meta.assets_root %>/material',
                src: ['**/*.css'],
                dest: '<%= meta.assets_minified_root %>/material',
                ext: '.css'
            },
            ...
            admin_demo_css: {
                files: {
                    '<%= meta.assets_minified_DEMO %>admin-all-demo.css': [
                        ...
                        '<%= meta.assets_root %>/material/ripple.css',
